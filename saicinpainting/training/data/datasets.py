...
from saicinpainting.evaluation.data import OurInpaintingDataset as OurInpaintingEvaluationDataset
from saicinpainting.evaluation.data import ceil_modulo, InpaintingEvalOnlineDataset
